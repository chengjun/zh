...
### 博士生
- **招收**明年入学的博士生。请将申请材料发送到[我的邮箱📮](mailto:wangchengjun@nju.edu.cn)，申请材料包括：a.个人简历、b.成绩单、c.代表性论文或手稿、d.个人传记。其中，个人传记包括：（1）个人经历、（2）编程能力和作品（尽量详细）、（3）数学或物理学建模能力和作品（尽量详细）、（4）如何分享知识和技能（**重点介绍富有吸引力的知识分享项目或计划**）、（5）动机（**重点介绍为什么要读研？** 如何对抗内卷？想要研究什么困惑？）、（6）为什么选择我的课题组、（7）将来的职业规划、（8）个人最大的优点和缺点等。
